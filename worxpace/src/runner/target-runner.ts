...
import { Run, type TargetDef } from '../pkg/schema.js'
...
export async function runTarget(fqt: FQT, target: TargetDef, depResults: TargetResult[], root: string, deps: TargetRunnerDeps): Promise<TargetResult> {
